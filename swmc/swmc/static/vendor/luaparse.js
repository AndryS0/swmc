/* luaparse 0.3.1 -- https://github.com/fstirlitz/luaparse  (MIT)
 *
 * Vendored, not fetched at runtime, so the editor keeps working offline and
 * the exact parser version is pinned with the rest of the source.
 *
 * Stormworks embeds Lua 5.3 -- the _VERSION string sits at 0x140ade5d8 in
 * stormworks64.exe, next to the Lua error messages -- so the editor parses
 * with luaVersion: '5.3'.
 */
